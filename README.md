About safety-schemas-feedstock
==============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/safety-schemas-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/safety-schemas-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add safety-schemas
# for installing globally
pixi global install safety-schemas
```
...
It is possible to list all of the versions of `safety-schemas` available on your platform:
...
```
pixi search safety-schemas --channel conda-forge
```
